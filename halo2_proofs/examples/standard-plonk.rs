...
use halo2_proofs::{
    ...
    plonk::{Advice, Circuit, Column, ConstraintSystem, Error, Fixed, create_proof, keygen_pk, keygen_vk, verify_proof},
    poly::{
        Rotation,
...
pub struct StandardPlonkConfig<F: PrimeField> {
    a: Column<Advice>,
    b: Column<Advice>,
    c: Column<Advice>,
    #[allow(dead_code)]
...
impl<F: PrimeField> StandardPlonkConfig<F> {
...
pub struct StandardPlonk<F: PrimeField> {
    pub x: Value<F>,
}
