    ...
    Scalar: Field,
{
    ...
    _phantom1: std::marker::PhantomData<Scalar>,
...
Scalar: Field,
{
    ...
    pub fn radix_fft(&mut self, input: &mut [G], omega: &Scalar, log_n: u32) -> EcResult<()> {
    ...
    fn create_optional_abort(
        ...
        let kernels: Vec<_> = programs
            ...
            .filter_map(|program| {
                ...
                let kernel = SingleFftKernel::<Scalar,G>::create(program, maybe_abort);
